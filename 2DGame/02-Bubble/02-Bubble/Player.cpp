...
void Player::init(const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram)
{
	...
	sprite = Sprite::createSprite(glm::ivec2(99, 55), glm::vec2(0.2, 1), &spritesheet, &shaderProgram);
	sprite->setNumberAnimations(6);
	
		sprite->setAnimationSpeed(MOVE_LEFT, 6);
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.f, 0.16666666f));
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.125f, 0.16666666f));
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.125f * 2, 0.16666666f));
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.125f * 3, 0.16666666f));
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.125f * 4, 0.16666666f));
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.125f * 5, 0.16666666f));
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.125f * 6, 0.16666666f));
		sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.125f * 7, 0.16666666f));
